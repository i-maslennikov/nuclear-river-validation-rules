    ...
    public sealed class LegalPersonProfileBargainShouldNotBeExpiredMessageSerializer : IMessageSerializer
    {
        ...
        public LocalizedMessage Serialize(Message message)
        {
            ...
            return new LocalizedMessage(message.GetLevel(),
                                        ...
                                        $"У юр. лица клиента, в профиле {_linkFactory.CreateLink(legalPersonProfileReference)} указан договор с датой окончания действия раньше даты подписания заказа");
        }
    }
}