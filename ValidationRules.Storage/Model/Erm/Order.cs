...
namespace NuClear.ValidationRules.Storage.Model.Erm
{
    public sealed class Order
    {
        ...
        public const int OrderTypeService = 11;

        public static readonly int[] FreeOfChargeTypes = { OrderTypeSelfAds, OrderTypeSocialAds, OrderTypeCompensation, OrderTypeInternational, OrderTypeService };
