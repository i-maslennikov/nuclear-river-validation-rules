...
namespace NuClear.ValidationRules.Replication.ConsistencyRules.Validation
{
    ...
    /// </summary>
    public sealed class OrderEndDistrubutionShouldBeLastSecondOfMonthActor : IActor
    {
        public const int MessageTypeId = 19;
        ...
        public OrderEndDistrubutionShouldBeLastSecondOfMonthActor(ValidationRuleShared validationRuleShared)
        {
