...
namespace NuClear.ValidationRules.Replication.ProjectRules.Validation
{
    ...
    /// </summary>
    public sealed class LinkedFirmAddressMustBeLocatedOnTheMap : ValidationResultAccessorBase
    {
        ...
        public LinkedFirmAddressMustBeLocatedOnTheMap(IQuery query) : base(query, MessageTypeCode.OrderAdvertisementAddressMustBeLocatedOnTheMap)
        {
        }
        ...
        protected override IQueryable<Version.ValidationResult> GetValidationResults(IQuery query)
        {
            var ruleResults = from order in query.For<Order>()
                              ...
                              from firmAddress in query.For<Firm.Address>().Where(x => x.Id == advertisement.AddressId && !x.IsLocatedOnTheMap)
