...
namespace NuClear.ValidationRules.Replication.AdvertisementRules.Validation
{
    ...
    /// </summary>
    public sealed class OrderContainsDummyAdvertisement : ValidationResultAccessorBase
    {
        ...
        public OrderContainsDummyAdvertisement(IQuery query) : base(query, MessageTypeCode.OrderContainsDummyAdvertisement)
        {
        }
