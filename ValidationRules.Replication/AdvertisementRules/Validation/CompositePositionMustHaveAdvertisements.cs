...
namespace NuClear.ValidationRules.Replication.AdvertisementRules.Validation
{
    ...
    /// </summary>
    public sealed class CompositePositionMustHaveAdvertisements : ValidationResultAccessorBase
    {
        ...
        public CompositePositionMustHaveAdvertisements(IQuery query) : base(query, MessageTypeCode.CompositePositionMustHaveAdvertisements)
        {
        }
        ...
        protected override IQueryable<Version.ValidationResult> GetValidationResults(IQuery query)
        {
            var ruleResults = from order in query.For<Order>()
                              join fail in query.For<Order.AdvertisementRequiredComposite>() on order.Id equals fail.OrderId
