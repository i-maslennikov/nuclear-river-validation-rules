    ...
    public sealed partial class TestCaseMetadataSource
    {
        ...
        private static ArrangeMetadataElement OrderBeginDistrubutionShouldBeFirstDayOfMonth
            => ArrangeMetadataElement
                ...
                .Aggregate(
                    new Aggregates::Order { Id = 1, BeginDistribution = MonthStart(1).AddDays(1), EndDistributionPlan = MonthStart(2) },
                    new Aggregates::Order.InvalidBeginDistributionDate { OrderId = 1 })
                .Message(
