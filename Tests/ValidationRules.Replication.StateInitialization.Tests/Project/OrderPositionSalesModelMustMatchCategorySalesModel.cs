                ...
                .Message(
                    new Messages::Version.ValidationResult
                    {
                        MessageParams = XDocument.Parse(
                                "<root><category id=\"12\" name=\"Category\" /><orderPosition id=\"1\" name=\"Position\" /><order id=\"1\" number=\"Order\" /><project id=\"0\" number=\"Project\" /></root>"),
                    ...
                    {
                        MessageParams = XDocument.Parse(
                                "<root><category id=\"12\" name=\"Category\" /><orderPosition id=\"4\" name=\"Position\" /><order id=\"4\" number=\"Order\" /><project id=\"0\" number=\"Project\" /></root>"),
                        MessageType = (int)MessageTypeCode.OrderPositionSalesModelMustMatchCategorySalesModel,
                        Result = 255,
