        ...
        private static ArrangeMetadataElement AdvertisementCountPerThemeShouldBeLimited
            => ArrangeMetadataElement
                ...
                .Aggregate(
                    ...
                    new Aggregates::OrderPosition { OrderId = 1, ThemeId = 3 },
                    new Aggregates::OrderPosition { OrderId = 1, ThemeId = 3 },
                    new Aggregates::OrderPosition { OrderId = 1, ThemeId = 3 },
                    new Aggregates::OrderPosition { OrderId = 1, ThemeId = 3 },
                    new Aggregates::OrderPosition { OrderId = 1, ThemeId = 3 },
                    ...
                    new Aggregates::OrderPosition { OrderId = 2, ThemeId = 3 },
                    ...
                    new Aggregates::OrderPosition { OrderId = 3, ThemeId = 3 },
                    ...
                    new Aggregates::OrderPosition { OrderId = 4, ThemeId = 3 },
                    new Aggregates::OrderPosition { OrderId = 4, ThemeId = 3 },
                    new Aggregates::OrderPosition { OrderId = 4, ThemeId = 3 },
                    new Aggregates::OrderPosition { OrderId = 4, ThemeId = 3 },
                    new Aggregates::OrderPosition { OrderId = 4, ThemeId = 3 },
