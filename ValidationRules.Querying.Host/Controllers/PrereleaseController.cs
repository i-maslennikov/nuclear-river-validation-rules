...
namespace NuClear.ValidationRules.Querying.Host.Controllers
{
    ...
    public class PrereleaseController : ApiController
    {
        ...
        public PrereleaseController(VersioningService versioningService, ValidationResultRepositiory repositiory, ValidationResultFactory factory, CheckModeDescriptorFactory descriptorFactory)
        {
