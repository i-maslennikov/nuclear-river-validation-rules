...
namespace NuClear.ValidationRules.Querying.Host.Controllers
{
    ...
    public class ManualWithAccountController : ApiController
    {
        ...
        public ManualWithAccountController(MessageRepositiory repositiory, ValidationResultFactory factory)
        {
        ...
        public IHttpActionResult Post([FromBody]ApiRequest request, [FromUri]Guid stateToken)
        {
            ...
            var messages = _repositiory.GetMessages(versionId, request.OrderIds, request.ProjectId, request.ReleaseDate, request.ReleaseDate.AddMonths(1), ResultType.ManualWithAccount);
