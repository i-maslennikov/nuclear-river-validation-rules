...
namespace NuClear.ValidationRules.Querying.Host.Controllers
{
    ...
    public class ManualWithAccountController : ApiController
    {
        ...
        public ManualWithAccountController(ValidationResultRepositiory repositiory, ValidationResultFactory factory, CheckModeDescriptorFactory descriptorFactory)
        {
