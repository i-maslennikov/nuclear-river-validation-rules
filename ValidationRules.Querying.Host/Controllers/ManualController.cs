...
namespace NuClear.ValidationRules.Querying.Host.Controllers
{
    ...
    public class ManualController : ApiController
    {
        ...
        public ManualController(VersioningService versioningService, ValidationResultRepositiory repositiory, ValidationResultFactory factory, CheckModeDescriptorFactory descriptorFactory)
        {
