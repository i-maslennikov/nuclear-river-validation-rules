...
namespace NuClear.ValidationRules.Querying.Host.Controllers
{
    ...
    public class ManualController : ApiController
    {
        ...
        public ManualController(MessageRepositiory repositiory, ValidationResultFactory factory, ICheckModeDescriptorFactory descriptorFactory)
        {
            _repositiory = repositiory;
            _factory = factory;
            _checkModeDescriptor = descriptorFactory.GetDescriptorFor(ResultType.Manual);
        }
