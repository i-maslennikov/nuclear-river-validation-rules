...
{
    public sealed class OrderPositionSalesModelMustMatchCategorySalesModelSingleMessageComposer : IMessageComposer
    {
        public MessageTypeCode MessageType => MessageTypeCode.OrderPositionSalesModelMustMatchCategorySalesModelSingle;
